...
public:
	...
	double getValue(int i, int j) const; /* çäĺńü íóćíî ââîäčňü ńňđîęó č ńňîëáĺö, ďđčâű÷íűĺ ÷ĺëîâĺęó ,ŕ íĺ ęîěďüţňĺđó*/
	void setValue(int i, int j, double value) /* çäĺńü íóćíî ââîäčňü ńňđîęó č ńňîëáĺö, ďđčâű÷íűĺ ÷ĺëîâĺęó ,ŕ íĺ ęîěďüţňĺđó*/;
	double det() const;
